...
termino_tabuada = int(input('Terminar em --> '))

if termino_tabuada < inicio_tabuada:
    print('\nTermino nao pode ser menor do que o Inicio')
else:
    print(f'Vou montar a tabuada de {numero_tabuada} começando em {inicio_tabuada} e terminando em {termino_tabuada}:')
    for i in range(inicio_tabuada, termino_tabuada+1):
