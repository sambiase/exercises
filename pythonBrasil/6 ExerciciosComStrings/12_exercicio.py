...
nr_tel = str(input('Digite um numero de telefone --> '))


if len(nr_tel) == 7:
    print('Telefone possui 7 dígitos. Vou acrescentar o digito três na frente.')
    print(f'Telefone corrigido sem formatação: 3{nr_tel}')
    print(f'Telefone corrigido com formatação: 3{nr_tel[:3]}-{nr_tel[3:]}')
